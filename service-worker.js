...
const STATIC_ASSETS = [
  ...
  './scripts/app/background.js', './scripts/app/playback-policy.js',
  './scripts/app/player-ui.js', './scripts/app/gallery.js',
  './scripts/app/albums.js', './scripts/app/downloads.js',
  './scripts/ui/notify.js', './scripts/ui/favorites.js',
  './scripts/ui/sleep.js', './scripts/ui/modals.js',
...
self.addEventListener('message', e => {
  const { type } = e.data || {};
  if (type === 'GET_SW_VERSION' && e.ports?.[0]) {
