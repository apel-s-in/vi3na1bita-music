...
const CORE_ASSETS = ['./','./index.html','./oauth-callback.html','./manifest.json','./albums.json','./audio/silence.mp3','./data/lyrics-index-v1.json','./data/track-profiles-index.json','./styles/base.css','./styles/ui-core.css','./styles/main.css','./styles/album-carousel.css','./styles/player.css','./styles/showcase.css','./styles/offline.css','./styles/profile.css','./styles/shards.css','./styles/games.css','./img/logo.png','./icons/ui-sprite.svg','./icons/favicon-32.png','./icons/favicon-16.png','./icons/apple-touch-icon.png','./scripts/vendor/howler.min.js','./scripts/core/bootstrap.js','./scripts/core/config.js','./scripts/core/utils.js','./scripts/core/favorites-manager.js','./scripts/core/device-identity.js','./scripts/core/device-context.js','./scripts/core/device-profile.js','./scripts/core/device-linking.js','./scripts/core/yandex-auth.js','./scripts/core/timezone-policy.js','./scripts/core/yandex-disk-transport.js','./scripts/core/yandex-backup-disk.js','./scripts/core/yandex-device-settings-disk.js','./scripts/core/yandex-event-archive-disk.js','./scripts/core/yandex-ledger-disk.js','./scripts/core/yandex-disk.js','./scripts/core/yandex-backup-v7.js','./src/PlayerCore.js','./src/player-core/media-session.js','./src/player-core/ios-audio-keeper.js'];
const PROFILE_ASSETS = ['./scripts/app/profile/view.js','./scripts/app/profile/model.js','./scripts/app/profile/render-shell.js','./scripts/app/profile/profile-tab-renderers.js','./scripts/app/profile/profile-tab-bindings.js','./scripts/app/profile/account-bindings.js','./scripts/app/profile/profile-render-kit.js','./scripts/app/profile/cloud-action-render-kit.js','./scripts/app/profile/archive-render-kit.js','./scripts/app/profile/ledger-health-modal.js','./scripts/app/profile/trust-check-modal.js','./scripts/app/profile/archive-maintenance-modal.js','./scripts/app/profile/account-benefits-view.js','./scripts/app/profile/account-timezone-view.js','./scripts/app/profile/account-devices-view.js','./scripts/app/profile/account-device-initialization.js','./scripts/app/profile/tab-strip-physics.js','./scripts/app/profile/actions-trash.js','./scripts/app/profile/actions.js','./scripts/app/profile/live-bindings.js','./scripts/app/profile/stats-view.js','./scripts/app/profile/recs-view.js','./scripts/app/profile/logs-formatters.js','./scripts/app/profile/logs-view.js','./scripts/app/profile/yandex-actions.js','./scripts/app/profile/backup-info-modal.js','./scripts/app/profile/restore-preview-modal.js','./scripts/app/profile/restore-diff.js','./scripts/app/profile/restore-card-render-kit.js','./scripts/app/profile/fresh-restore-modal.js','./scripts/app/profile/account-cloud-renderers.js','./scripts/app/profile/yandex-auth-view.js','./scripts/app/profile/yandex-auto-sync.js','./scripts/app/profile/yandex-runtime-refresh.js','./scripts/app/profile/auth-onboarding-orchestrator.js','./scripts/app/profile/yandex-preload-cache.js','./scripts/app/profile/cloud-ui-helpers.js','./scripts/app/profile/restore-decision.js','./scripts/app/profile/restore-backup-runner.js','./scripts/app/profile/achievements-view.js','./scripts/app/profile/loyalty-card.js','./scripts/app/profile/carousel-flat.js','./scripts/app/profile/template.js','./scripts/app/profile/settings-download-section.js','./scripts/app/profile/settings-interface-section.js','./scripts/app/profile/settings-conflict-section.js','./scripts/app/profile/settings-trash-section.js','./scripts/app/profile/settings-data-section.js','./scripts/app/profile/settings-view.js'];
const ANALYTICS_ASSETS = ['./scripts/analytics/cloud-contract.js','./scripts/analytics/account-data-boundary.js','./scripts/analytics/snapshot-contract.js','./scripts/analytics/device-settings-contract.js','./scripts/analytics/backup-delta-contract.js','./scripts/analytics/stats-shard-contract.js','./scripts/analytics/backup-v7-range.js','./scripts/analytics/backup-v7-sync.js','./scripts/analytics/event-archive-contract.js','./scripts/analytics/event-integrity.js','./scripts/analytics/trust-state.js','./scripts/analytics/event-contract.js','./scripts/analytics/tombstone-contract.js','./scripts/analytics/achievement-state.js','./scripts/analytics/stats-state.js','./scripts/analytics/confirmed-listening-stats.js','./scripts/analytics/loyalty-state.js','./scripts/analytics/sync-revisions.js','./scripts/analytics/sync-dirty-events.js','./scripts/analytics/backup-event-cleanup.js','./scripts/analytics/backup-builders.js','./scripts/analytics/event-archive-sync.js','./scripts/analytics/event-archive-restore.js','./scripts/analytics/archive-maintenance.js','./scripts/analytics/archive-branch-validation.js','./scripts/analytics/backup-debug.js','./scripts/analytics/backup-upload-runner.js','./scripts/analytics/backup-importers.js','./scripts/analytics/sync-state.js','./scripts/analytics/sync-scheduler.js','./scripts/analytics/sync-cloud-guard.js','./scripts/analytics/backup-sync-engine.js','./scripts/analytics/backup-branch-compare.js','./scripts/analytics/backup-recovery.js','./scripts/analytics/storage-merge-utils.js','./scripts/analytics/favorite-state-contract.js','./scripts/analytics/playlists-storage-merge.js','./scripts/analytics/storage-merge.js','./scripts/analytics/device-registry.js','./scripts/analytics/meta-db.js','./scripts/analytics/event-logger.js','./scripts/analytics/session-tracker.js','./scripts/analytics/playback-fence.js','./scripts/analytics/listening-receipts.js','./scripts/analytics/playback-ownership.js','./scripts/analytics/favorite-mirror.js','./scripts/analytics/stats-aggregator.js','./scripts/analytics/achievement-engine.js','./scripts/analytics/achievements-dict.js','./scripts/analytics/live-stats.js','./scripts/analytics/playback-runtime.js','./scripts/analytics/playback-validity.js','./scripts/analytics/temporal-buckets.js','./scripts/analytics/backup-summary.js','./scripts/analytics/backup-vault.js','./scripts/analytics/share-generator.js'];
const UI_ASSETS = ['./scripts/ui/icon-utils.js','./scripts/ui/notify.js','./scripts/ui/sleep-timer.js','./scripts/ui/lyrics-modal.js','./scripts/ui/sysinfo.js','./scripts/ui/modals.js','./scripts/ui/offline-modal.js','./scripts/ui/offline-indicators.js','./scripts/ui/cache-progress-overlay.js','./scripts/ui/track-statistics-modal.js','./scripts/ui/statistics-modal.js','./scripts/ui/progress-formatters.js','./scripts/ui/logo-pulse.js','./scripts/ui/news-inline.js','./scripts/ui/app-modals.js','./scripts/app/gallery.js','./scripts/app/player/favorites-only-resolver.js','./scripts/app/player/favorites-only-actions.js','./scripts/app/player/playback-context-source.js','./scripts/app/player/playback-clock.js','./scripts/app/player/restore-gesture.js','./scripts/app/playback-return-ui.js','./scripts/app/player-ui.js','./scripts/app/player-ui/lyrics.js','./scripts/app/albums.js','./scripts/app/albums/specials.js','./scripts/app/albums/album-carousel.js','./scripts/app/albums/album-icons-renderer.js','./scripts/app/albums/album-track-renderer.js','./scripts/app/albums/album-playback-builder.js','./scripts/app/albums/album-track-actions.js','./scripts/app/friends/friends-block.js','./scripts/app/shards/wallet-service.js','./scripts/app/shards/reward-notifier.js','./scripts/app/shards/view.js','./scripts/app/games/config.js','./scripts/app/games/host.js','./scripts/app/games/bridge-host.js','./scripts/app/track-registry.js','./scripts/app/offline-ui-bootstrap.js','./scripts/app/playback-cache-bootstrap.js','./scripts/app/showcase/index.js','./scripts/app/showcase/actions.js','./scripts/app/showcase/edit.js','./scripts/app/showcase/lyrics-search.js','./scripts/app/showcase/modals.js','./scripts/app/showcase/playlists.js','./scripts/app/showcase/render.js','./scripts/app/showcase/search.js','./scripts/app/showcase/store.js','./scripts/app/promocode.js','./scripts/app/pwa-install.js','./scripts/app/push/web-push.js','./scripts/app/push/loyalty-reminders.js','./scripts/app.js','./scripts/offline/cache-db.js','./scripts/offline/net-policy.js','./scripts/offline/offline-manager.js','./scripts/offline/track-resolver.js','./scripts/offline/update-checker.js'];
