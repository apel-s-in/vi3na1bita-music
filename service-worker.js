...
const PROFILE_ASSETS = ['./scripts/app/profile/view.js','./scripts/app/profile/model.js','./scripts/app/profile/render-shell.js','./scripts/app/profile/profile-tab-renderers.js','./scripts/app/profile/profile-tab-bindings.js','./scripts/app/profile/account-bindings.js','./scripts/app/profile/profile-render-kit.js','./scripts/app/profile/cloud-action-render-kit.js','./scripts/app/profile/account-benefits-view.js','./scripts/app/profile/account-timezone-view.js','./scripts/app/profile/account-devices-view.js','./scripts/app/profile/account-device-initialization.js','./scripts/app/profile/tab-strip-physics.js','./scripts/app/profile/actions-trash.js','./scripts/app/profile/actions.js','./scripts/app/profile/live-bindings.js','./scripts/app/profile/stats-view.js','./scripts/app/profile/recs-view.js','./scripts/app/profile/logs-formatters.js','./scripts/app/profile/logs-view.js','./scripts/app/profile/yandex-actions.js','./scripts/app/profile/backup-info-modal.js','./scripts/app/profile/account-cloud-renderers.js','./scripts/app/profile/yandex-auth-view.js','./scripts/app/profile/yandex-runtime-refresh.js','./scripts/app/profile/cloud-ui-helpers.js','./scripts/app/profile/achievements-view.js','./scripts/app/profile/loyalty-card.js','./scripts/app/profile/carousel-flat.js','./scripts/app/profile/template.js','./scripts/app/profile/settings-download-section.js','./scripts/app/profile/settings-interface-section.js','./scripts/app/profile/settings-conflict-section.js','./scripts/app/profile/settings-trash-section.js','./scripts/app/profile/settings-data-section.js','./scripts/app/profile/settings-view.js'];
const ANALYTICS_ASSETS = ['./scripts/analytics/account-data-boundary.js','./scripts/analytics/snapshot-contract.js','./scripts/analytics/device-settings-contract.js','./scripts/analytics/backup-v7-range.js','./scripts/analytics/backup-v7-sync.js','./scripts/analytics/event-integrity.js','./scripts/analytics/trust-state.js','./scripts/analytics/event-contract.js','./scripts/analytics/tombstone-contract.js','./scripts/analytics/achievement-state.js','./scripts/analytics/stats-state.js','./scripts/analytics/confirmed-listening-stats.js','./scripts/analytics/loyalty-state.js','./scripts/analytics/sync-revisions.js','./scripts/analytics/sync-dirty-events.js','./scripts/analytics/backup-event-cleanup.js','./scripts/analytics/backup-sync-engine.js','./scripts/analytics/favorite-state-contract.js','./scripts/analytics/playlists-storage-merge.js','./scripts/analytics/device-registry.js','./scripts/analytics/meta-db.js','./scripts/analytics/event-logger.js','./scripts/analytics/session-tracker.js','./scripts/analytics/playback-fence.js','./scripts/analytics/listening-receipts.js','./scripts/analytics/playback-ownership.js','./scripts/analytics/favorite-mirror.js','./scripts/analytics/stats-aggregator.js','./scripts/analytics/achievement-engine.js','./scripts/analytics/achievements-dict.js','./scripts/analytics/live-stats.js','./scripts/analytics/playback-runtime.js','./scripts/analytics/playback-validity.js','./scripts/analytics/temporal-buckets.js','./scripts/analytics/backup-summary.js','./scripts/analytics/share-generator.js'];
