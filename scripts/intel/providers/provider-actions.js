...
// UID.095_(Ownership boundary: legacy vs intel)_(provider-actions не должны становиться UI, auth или playback-слоем)_(модуль только маршрутизирует capability-based external actions без side effects на core ownership)
