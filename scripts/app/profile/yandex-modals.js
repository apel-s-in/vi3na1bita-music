...
export const openFreshLoginRestoreModal = ({ meta, items = [], onRestore, onNewDevice, onLater, currentDeviceInfo = null } = {}) => {
  ...
  // Блок с текущим устройством (если передан из orchestrator)
