...
const renderBackupHistoryRow = device => renderSmallListRow({
  ...
  desc: `${[device.class, device.platform, device.pwa ? 'PWA' : '', device.lastSeenAt ? fmt(device.lastSeenAt) : ''].filter(Boolean).join(' · ')} · только история backup`,
