...
const setDlFmt = v => { localStorage.setItem('dl_format_v1', JSON.stringify(v)); try { window.dispatchEvent(new CustomEvent('backup:domain-dirty', { detail: { domain: 'deviceSettings' } })); } catch {} };
