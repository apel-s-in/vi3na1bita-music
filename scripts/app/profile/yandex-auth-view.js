...
export function renderYandexAuthBlock({ root, localProfile }) {
  ...
  if (st === 'active' && pr) {
    ...
    root.innerHTML = renderYandexConnectedBlock({ profile:pr, statusLabel:sL, statusColor:sC, hasDiskAccess:hDA, avatarHtml, lastSyncLabel:lSL, autosaveChecked:aCh, autoRelogin:aL });
