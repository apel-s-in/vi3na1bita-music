...
export function renderYandexAuthBlock({ root, localProfile }) {
  ...
  if (st === 'active' && pr) {
    ...
    root.innerHTML = `<div class="yandex-auth-block">
      ...
      <div style="display:flex;align-items:center;gap:8px;font-size:11px;color:#7f93b5;padding:2px 0;margin-bottom:4px"><span style="flex:1;color:#888">Автосохранение срабатывает по изменениям профиля</span><span style="color:#888;font-size:11px">Cooldown: 1 мин</span></div>
