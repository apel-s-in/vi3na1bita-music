...
function _initBadgeListeners() {
  ...
  // Fresh-login и manual restore теперь обслуживает auth-onboarding-orchestrator.js напрямую из yandex-auth.js.
  // Слушатель yandex:restore:entry удалён как устаревший — всё управление flow теперь в одном месте.
}
