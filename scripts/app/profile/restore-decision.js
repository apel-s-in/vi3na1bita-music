...
export const pickDeviceSettingsRestoreKey = ({ backup:b, inheritDeviceKey:iK=null, asNewDevice:aN=false }={}) => !aN&&(sS(iK)||sS(b?.revision?.sourceDeviceStableId)&&Array.isArray(b?.devices)&&b.devices.length>0)?sS(iK||b?.revision?.sourceDeviceStableId):'';
