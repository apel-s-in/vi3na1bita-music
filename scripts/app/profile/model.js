...
export const loadProfileModel = async () => {
  ...
  const sum = getStatsSummary(all);
  return { metaDB: db, all, ach, streak, profile, totalFull: sum.totalFull, totalSec: sum.totalSec, tokens: {} };
};
