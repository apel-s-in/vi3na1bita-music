...
(function PlayerUIModule() {
  ...
  function updatePQButtonUI() {
    ...
    // ТЗ 4.1: disabled если нет альтернативы или нет сети
    if (!canToggle || !online) {
      btn.classList.add('disabled');
    }
  }

  // ==================== FAVORITES ONLY (F) — ТЗ 6 ====================
  ...
  // Обратная совместимость с LyricsController
