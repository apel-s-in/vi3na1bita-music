export const renderShowcaseHeader = ({ edit: e, query: q, sortMode: s, resetAble: r, dirty: d, esc }) => `
  <div class="showcase-header-controls">
    ...
    ${!e ? `<div class="showcase-btns-row"><button class="showcase-btn sc-btn-edit">✏️ Редактировать</button>${r ? `<button class="showcase-btn sc-btn-master-reset sc-btn-half">↺ Сброс</button>` : ''}<button class="showcase-btn sc-btn-sort">⚙️ ${s !== 'user' ? '●' : ''} Настроить</button></div>` : ''}
