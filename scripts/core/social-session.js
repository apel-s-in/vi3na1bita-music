...
const quietBackgroundActions = new Set(['achievement_reward_status', 'favorite_state_get', 'wallet_get', 'timezone_policy_get', 'account_device_list', 'playback_state_get', 'presence_heartbeat', 'presence_batch', 'push_poll', 'friend_list', 'friend_status_check', 'leaderboard_v2_get', 'ranked_stats_get']);
