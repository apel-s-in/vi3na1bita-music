...
const main = async () => {
  ...
  validateBackupProxy();
  contains('scripts/analytics/backup-delta-contract.js', "BACKUP_DELTA_VERSION = '7.0'");
  contains('scripts/analytics/stats-shard-contract.js', 'buildStatsProjectionShard');
