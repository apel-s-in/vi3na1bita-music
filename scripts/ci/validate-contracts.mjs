...
const validatePlaybackOwnershipFoundation = () => {
  ...
  ['timezone_policy_get', 'timezone_policy_set', 'account_device_list', 'account_device_update', 'playback_state_get', 'timezonePolicyKey', 'accountDeviceKey', 'playbackStateKey', 'alwaysConfirm'].forEach(marker => contains(server, marker));
