...
const validatePlaybackOwnershipFoundation = () => {
  ...
  ['account_device_list', 'account_device_update', 'takeoverEnabled', 'remotePauseEnabled', 'alwaysConfirm', 'initializationPending', 'inheritedFromDeviceId'].forEach(marker => contains('scripts/app/profile/account-devices-view.js', marker));
