...
const validatePlaybackOwnershipFoundation = () => {
  ...
  ['timezone_policy_get', 'timezone_policy_set', 'account_device_list', 'account_device_update', 'playback_state_get', 'playback_claim', 'playback_transfer_prepare', 'playback_transfer_commit', 'timezonePolicyKey', 'accountDeviceKey', 'playbackStateKey', 'playbackTransferKey', 'fencingTokenHash', 'ownerEpoch', 'alwaysConfirm'].forEach(marker => contains(server, marker));
