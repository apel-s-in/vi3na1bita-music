...
const validateRecommendationsAndStats = () => {
  ...
  contains('scripts/app/gallery-recommendation-cards.js', "'new-year'");
  ...
  contains('scripts/intel/roadmap.js', 'ПЛАНИРУЕМАЯ КОРОТКОЖИВУЩАЯ ОЧЕРЕДЬ');
  contains('scripts/intel/roadmap.js', 'До выполнения этих тестов методы enqueueNext');
