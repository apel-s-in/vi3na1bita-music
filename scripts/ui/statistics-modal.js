...
export async function openStatisticsModal(uid = null) {
  ...
  const bodyHtml = `
    <div style="padding:14px 0 0; color:rgba(234,242,255,.72); font-size:12px; line-height:1.35; text-align:center; margin-bottom:14px;">
      Не удалось определить текущий трек. Показана общая статистика.
    </div>
