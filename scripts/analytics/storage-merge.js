// UID.096_(Helper-first anti-duplication policy)_(storage merge — каноническое имя вместо backup-merge)_(backup-merge остаётся только facade)
// UID.099_(Multi-device sync model)_(favorites/playlists/profile merge в одном public API)_(без circular imports)
