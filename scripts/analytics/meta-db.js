export class MetaDB {
  ...
  async addEvent(event) { return this._tx('events_hot', 'readwrite', store => store.add(event)); }
  async getEvents() { return this._tx('events_hot', 'readonly', store => store.getAll()); }
  async clearEvents() { return this._tx('events_hot', 'readwrite', store => store.clear()); }
