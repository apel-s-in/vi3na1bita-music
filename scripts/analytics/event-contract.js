...
export const getEventDomain = t => ({ LISTEN_START: 'listening', LISTEN_COMPLETE: 'listening', LISTEN_SKIP: 'listening', FEATURE_USED: 'feature', ACHIEVEMENT_UNLOCK: 'achievement', FAVORITE_CHANGED: 'favorites', PLAYLIST_CHANGED: 'playlists', PROFILE_UPDATED: 'profile', DEVICE_UPDATED: 'devices', AUTH_EVENT: 'auth', BACKUP_CREATED: 'cloud', RESTORE_APPLIED: 'cloud', SYNC_STATE_CHANGED: 'cloud', RECOMMENDATION_SHOWN: 'recommendations', RECOMMENDATION_CLICKED: 'recommendations', RECOMMENDATION_ACCEPTED: 'recommendations', RECOMMENDATION_DISMISSED: 'recommendations', RECOMMENDATION_CONTROLS_CHANGED: 'recommendations', UI_PERSONALIZATION_CHANGED: 'profile', GAME_STATE_CHANGED: 'games' }[sS(t)] || 'generic');
...
export const V7_SYNC_EVENT_TYPES = new Set([EVENT_TYPES.LISTEN_START, EVENT_TYPES.LISTEN_COMPLETE, EVENT_TYPES.LISTEN_SKIP, EVENT_TYPES.FEATURE_USED, EVENT_TYPES.PLAYLIST_CHANGED, EVENT_TYPES.RECOMMENDATION_SHOWN, EVENT_TYPES.RECOMMENDATION_CLICKED, EVENT_TYPES.RECOMMENDATION_ACCEPTED, EVENT_TYPES.RECOMMENDATION_DISMISSED, EVENT_TYPES.RECOMMENDATION_CONTROLS_CHANGED, EVENT_TYPES.UI_PERSONALIZATION_CHANGED, EVENT_TYPES.GAME_STATE_CHANGED]);
