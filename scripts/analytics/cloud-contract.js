...
export const normalizeCloudBackupMeta = (m = {}) => ({
  ...
  archivableLedgerHead: safeCloudString(m?.archivableLedgerHead || ''),
  archivableLedgerSeq: safeCloudNum(m?.archivableLedgerSeq),
  archivableLedgerDeviceStableId: safeCloudString(m?.archivableLedgerDeviceStableId || ''),
  archivableLedgerChainId: safeCloudString(m?.archivableLedgerChainId || ''),
  archivableEventCount: safeCloudNum(m?.archivableEventCount),
