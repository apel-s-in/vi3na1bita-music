...
import { buildFullBackupObject, buildDeviceSettingsObject, stableStringify, sha256Hex } from './backup-builders.js';
...
export class BackupVault {
  ...
  static async buildDeviceSettingsObject() { return await buildDeviceSettingsObject(); }
