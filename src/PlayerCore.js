...
// src/PlayerCore.js
// Optimized v1.1: Fixes Favorites empty state by resolving sourceAlbum via Registry.
  ...
  class PlayerCore {
    ...
    getFavoritesState() {
      ...
      Object.values(refs).forEach(r => {
        ...
        if (liked.has(u)) active.push(item);
    ...
    getLikedUidsForAlbum(albumKey) {
      ...
      // Iterate liked set and check registry to match album
